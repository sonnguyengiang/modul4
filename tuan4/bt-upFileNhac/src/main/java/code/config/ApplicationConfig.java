...
import code.services.FileMusicServices;
...
public class ApplicationConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/th2");
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry.addResourceHandler("/i/**")
                .addResourceLocations("file:D:\\codegym\\module4\\tuan4\\bt-upFileNhac\\src\\main\\webapp\\");
    }
    ...
    @Bean
    public IFileMusicServices iFileMusicServices(){
        return new FileMusicServices();
    }
