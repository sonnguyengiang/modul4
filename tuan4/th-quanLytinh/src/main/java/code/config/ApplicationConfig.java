...
import code.services.ConsciousServices;
...
public class ApplicationConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/th4");
    ...
    @Bean
    public IConsciousServices iConsciousServices(){
        return new ConsciousServices();
    }
